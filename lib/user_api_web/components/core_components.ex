defmodule UserApiWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(UserApiWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(UserApiWeb.Gettext, "errors", msg, opts)
    end
  end
